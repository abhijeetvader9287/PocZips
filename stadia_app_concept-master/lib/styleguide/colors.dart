...
Color firstGradiantColor = Colors.green;
Color secondGradiantColor =Colors.orange;
Color opacityCOlor = Colors.white.withOpacity(0.9);

LinearGradient appGradient = LinearGradient(colors: [firstGradiantColor, secondGradiantColor]);