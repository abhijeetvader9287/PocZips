...
public class MainActivity extends AppCompatActivity implements MovieRecyclerViewAdapter.ItemClickListener {
    ...
    private void fetchMovies(int taskId, String taskQuery) {
        ...
        switch (taskId) {
            case SEARCH_TASK:
                call = retrofitAPI.searchMovies(getString(R.string.TMDB_API_TOKEN), "en-US", 1, taskQuery);
                break;
            case POPULAR_TASK:
                call = retrofitAPI.getMovies("popular",getString(R.string.TMDB_API_TOKEN), "en-US", 1);
                break;
            case TOP_RATED_TASK:
                call = retrofitAPI.getMovies("top_rated", getString(R.string.TMDB_API_TOKEN), "en-US", 1);
                break;
            case UPCOMING_TASK:
                call = retrofitAPI.getMovies("upcoming", getString(R.string.TMDB_API_TOKEN), "en-US", 1);
                break;
            case NOW_PLAYING_TASK:
                call = retrofitAPI.getMovies("now_playing", getString(R.string.TMDB_API_TOKEN), "en-US", 1);
                break;
            default:
                call = retrofitAPI.getMovies("popular", getString(R.string.TMDB_API_TOKEN), "en-US", 1);
        }
