...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void InstallSmile() {
        if ((!InstallApkUtils.checkApkExist(this, InstallApkUtils.smilePkgName) && MyApplication.getInstance().isHaveCamera())
                ) {
            myHandler.postDelayed(new Runnable() {
                @Override
                public void run() {
                    InstallApkUtils.installApp(MainActivity.this, isVertical);
                }
            }, 3000);
        }
    }
